...
<b><i>\$_SERVER['SERVER_PROTOCOL'] = %s</i></b></li>\n", $_SERVER['SERVER_PROTOCOL']);
 printf("<li>El puerto de la máquina usado por el servidor web para la comunicación HTTP
es: <b><i>\$_SERVER['SERVER_PORT'] = %s</i></b></li>\n", $_SERVER['SERVER_PORT']);
 printf("<li>La dirección IP de su computadora es: <b><i>\$_SERVER['REMOTE_ADDR'] =
%s</i></b></li>\n", $_SERVER['REMOTE_ADDR']);
 printf("<li>La ruta del script actual en el servidor es: <b><i>\$_SERVER['SCRIPT_NAME']
= %s</i></b></li>\n", $_SERVER['SCRIPT_NAME']);
...
<b><i>\$_SERVER['REQUEST_URI'] = %s</i></b></li>\n", $_SERVER['REQUEST_URI']);
 printf("<li>El puerto empleado por el equipo del usuario para comunicarse con el servidor
es: <b><i>\$_SERVER['REMOTE_PORT'] = %s</i></b></li>\n", $_SERVER['REMOTE_PORT']);
