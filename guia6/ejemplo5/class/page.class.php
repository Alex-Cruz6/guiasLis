<?php
    ...
    class page
    {
        ...
        public $buttons = array(
            "Inicio" => "home.php","Carreras" => "carreras.php",
            "Institucional" => "institucional.php","Contacto" => "contacto.php"
        );
        ...
        public function displayFooter(){
            ...
            <!--Pie de la página -->
                <table id="footer">
                    <tr>
                        <td>
                            <p class="foot"><a href="http://www.udb.edu.sv" target="_blank">Universidad   Don Bosco</a></p>
