...
<body>
    <?php
        ...
        if(isset($_POST['enviar'])){
            if(isset($_POST['enviar'])){
                ...
                $pagohoraextra = (isset($_POST['pagohoraextra'])) ? doubleval($_POST['pagohoraextra']) : 0.0;
                //Creando instancias de la clase empleado
                $empleado1 = new empleado();
                $empleado1->obtenerSalarioNeto($name, $apellido, $sueldo, $prestamo, $numHorasExtras, $pagohoraextra);
            }
        }else{ 
            ?>
    <header>
    ...
    <section>
        <article>
            <form name="Info" id="Info" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                <fieldset>
                    <legend>
                    ...
                    <label for="prestamo">¿Poseé prestamos pendientes?:</label>
                    <input type="checkbox" name="presta" id="prestasi" value="no" /><span> No poseé</span>
