            ...
            <div class="contact-form">
                ...
                <div class="w-100">
                    ...
                    <form name="frmrectangulo" id="frmrectangulo" action="<?php    echo $_SERVER['PHP_SELF'] ?>"
                        ...
                        <div class="field"><input type="number" name="coordx1" id="coordx1" min="0" max="1000" step=".1"
                                placeholder="(x1)" required />
                            <span class="entypo-base icon"></span><span class="slick-tip left">Ingrese la coordenada
                                x1:</span>
                        </div>
                        <div class="field"><input type="number" name="coordy1" id="coordy2" min="0" max="1000" step=".1"
                                placeholder="(y1)" required /><span class="entypo-base icon"></span><span
                                class="slick-tip left">Ingrese la coordenada y1:</span></div>
                        <!--Coordenada 2 (x2,y2) --><label>Coordenada 2 (x2,y2): </label>
                        <div class="field"><input type="number" name="coordx2" id="coordx2" min="0" max="1000" step=".1"
                                placeholder="(x2)" required /><span class="entypo-base icon"></span><span
                                class="slick-tip left">Ingrese la coordenada x2:</span></div>
                        <div class="field"><input type="number" name="coordy2" id="coordy2" min="0" max="1000" step=".1"
                                placeholder="(y2)" required /><span class="entypo-base icon"></span><span
                                class="slick-tip left">Ingrese la coordenada y2:</span></div>
                        <!--Botones para hacer los cálculos --><input type="submit" value="Calcular" class="send"
                            name="submit" id="perimetro" /><input type="reset" value="Restablecer" class="send"
                            name="reset" id="area" />
                    </form>
                </div>
            </div>
