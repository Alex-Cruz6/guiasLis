        ...
        <?php 
            ...
            if (isset($_FILES["archivos"])) {
                ...
                for($i = 0; $i < $total; $i++){
                    ...
                    echo " bytes<br />";
                    //Verificar la carpeta enel servidor donde se alojarán los archivos 
                    ...
                    if(!file_exists(PATH)){
                        //Crear eldirectorio y asignar los permisos al mismo
                    ...
                    if(move_uploaded_file($tmp_name, PATH . "/" . utf8_decode($name))){
                        echo "Se ha cargado correctamente el archivo " . "<a  href=\"archivos/"  .  urldecode($name)  .  "\"  target=\"_blank\">"  . $name . "</a>\n" . " en el servidor.\n<br />\n";
                    }else{
