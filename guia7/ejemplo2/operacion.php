<?php
    ...
    function escribir_boton_volver($directorio){
        return "<form method=\"POST\" action=\"administrador.php?directorio=" .rawurlencode("$directorio") . "\">\n\t\t\t" 
    ...
    if(isset($_GET['operacion'])):
        if(($_GET['operacion'] >= 0 && $_GET['operacion'] <= 2 && 
                !chdir($_GET['directorio'])) || ($_GET['operacion'] >= 3 && 
                $_GET['operacion'] <= 5 && !chdir($ruta))):
            error(0, ".");
        endif;
        //Ejecutar la operación requerida
        switch($_GET['operacion']):
            case 0:
                if(empty($_POST['nombre_directorio']) || existe_en_directorio($_POST['nombre_directorio']) ||
                        !mkdir($_POST, 0777)):
            ...
            case 4:
                ...
                break;
            case 5:
                if(empty($_POST['nuevo_nombre']) || existe_en_directorio($_POST['nuevo_nombre']) ||
