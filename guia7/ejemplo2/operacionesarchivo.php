        ...
        <section>
            <article>
                ...
                <div class="ccfield-prepend">
                    ...
                    <input type="text" name="nuevo_nombre"id="nuevo_nombre" placeholder="Nuevo nombre" required class="ccformfield" />
                ...
                <?php
                    $form  = "<form method=\"POST\" action=\"";
                    $form .= "administrador.php?directorio=" . rawurlencode(dirname($_GET['directorio'])) . "\">\n\t\t\t";
                    echo $form;
                ?>
                <div class="ccfield-prepend">
