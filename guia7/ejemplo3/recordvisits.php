            ...
            <section id="container">
                ...
                <form  name="hongkiat"  id="hongkiat-form"  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div id="wrapping" class="clearfix">
                        ...
                        <section id="aside" class="clearfix">
                            <section id="recipientcase">
                                ...
                                <img src="jscalendar/image.png" id="imgcalendar" style="cursor: pointer; border: 1px solid red; display: inline-block;" title="Ingrese la fecha" onmouseover="this.style.background='red';" onmouseout="this.style.background=''" /><br />
                                <script type="text/javascript">
                                    Calendar.setup({
                                        inputField  : "yourbirthday",
                    ...
                    <section id="buttons">
                        ...
                        <input type="submit" name="submit" id="submitbtn" class="submitbtn" tabindex="7" value="Guardar" /><br style="clear:both;">
                    </section>
                </form>
            </section>
        <?php
