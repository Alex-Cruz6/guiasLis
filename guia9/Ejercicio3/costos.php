<?php
  ...
  $homepage = new page(
     "Costos - Nuevo Ingreso UDB", 
     "Costos de Nuevo Ingreso, Costos para alumnos de Nuevo Ingreso UDB, Costos de Ingreso", $menu
   );
  ...
  $homepage->content = <<<PAGE
          ...
          <p style="color:black;">(*) Los costos de ingreso dan derecho al Curso de Inducci&oacute;n a la Vida Universitaria,
