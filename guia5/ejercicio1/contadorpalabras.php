...
<html lang="es">
    <head>
        <meta charset="utf-8" />
        <!--Indicar al navegador que el sitio estará optimizado para dispositivos móviles -->
    ...
    <body>
        ...
        <section>
            <article class="container">
             <?php
                if(isset($_POST['btnContar'])):require "wordcount.php";
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="frmtexto" id="frmtexto" class="col s12">
                    <div class="row col s12">
                        <div class="input-field col s12">
                            <textarea name="area" id="text-box" placeholder="Ingrese un texto"  class="materialize-textarea col s12"></textarea>
