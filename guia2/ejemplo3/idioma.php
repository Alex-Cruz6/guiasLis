...
<body>
    <div id="wrapper">
        ...
        <section>
            <?php //Antes de nada introducimos mensajes en distintos idiomas //en forma de variables
                $espanol = "Hola";
                $ingles = "Hello";
                $aleman = "Hallo";
                $frances = "Bonjour";
                $italiano = "Ciao";
                $portugues = "Olá"; //Obtener del navegador cuál es el idioma establecido
                $completo = $_SERVER["HTTP_ACCEPT_LANGUAGE"];
                $idioma = substr($_SERVER["HTTP_ACCEPT_LANGUAGE"],0,2); 
                //Formulamos las posibilidades que se pueden dar//usando sentencia if-elseif-else
                echo "<p>" . $completo . "<br>";
                echo $idioma ."</p>\n";
                if($idioma == "es"){
                    echo '<p class="msgOff">';
